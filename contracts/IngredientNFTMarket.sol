...
contract IngredientNFTMarket is ERC721URIStorage, ReentrancyGuard {
    using Counters for Counters.Counter;
    Counters.Counter private _tokenIds;
    Counters.Counter private _itemsSold;
    address payable owner;
    CocktailNFT cocktailNFT;
    ...
    constructor() ERC721("Ingredients", "IGS") {
    ...
    function changeCocktailBase(address newBase)
        public
        onlyOwner
        returns (bool success)
    {
        cocktailNFT = CocktailNFT(newBase);
        return true;
    }
        ...
        external
    {
        ...
        cocktailNFT.createCocktail(_tokenURI, msg.sender);
    }
