...
function CocktailNFTBalance() {
const { authenticate, isAuthenticated, user } = useMoralis();
const address = user.get("ethAddress");
  const { NFTBalance, fetchSuccess } = useNFTBalance(address);
  const CocktailList = NFTBalance.filter(nft=>nft.token_address===process.env.REACT_APP_COCKTAIL_ADDRESS )
...
export default CocktailNFTBalance;
